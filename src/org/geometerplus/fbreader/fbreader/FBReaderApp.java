...
public final class FBReaderApp extends ZLApplication {
	...
	public FBReaderApp() {
        ...
        */
		...
		addAction(ActionCode.DPAD_SCROLL_FORWARD, new VolumeKeyTurnPageAction(this, true));
		addAction(ActionCode.DPAD_SCROLL_BACK, new VolumeKeyTurnPageAction(this, false));
